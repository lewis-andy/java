...
static String subjects[]={"OOP1","Operating System","Networking","OOP2","INternetTechnology","Java Servelets","Database Administration"};
...
//Setting Subject exam values. Every student take up 7 units and therefore we must


//capture the marks for the seven units
for (int i=0;i<7;i++){
